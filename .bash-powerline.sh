...
__powerline() {
    # Colors
    COLOR_RESET='\[\033[m\]'
    COLOR_CWD=${COLOR_CWD:-'\[\033[0;34;1m\]'} # blue
    COLOR_GIT=${COLOR_GIT:-'\[\033[0;36;1m\]'} # cyan
    COLOR_SUCCESS=${COLOR_SUCCESS:-'\[\033[0;32;1m\]'} # green
    COLOR_FAILURE=${COLOR_FAILURE:-'\[\033[0;31;1m\]'} # red
